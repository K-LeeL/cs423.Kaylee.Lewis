...
///https://github.com/nakov/TurtleGraphics.NET
/// https://nakov.com/blog/2016/02/14/turtle-graphics-net-csharp-open-source-library/

namespace CS423A02Turtle
{
     public class RobotTurtle
     {
          ...
          public void MoveForwardBySpaces ( int moveSpaces )
          {
               if ( moveSpaces < 0 )
               {
                    Console.WriteLine ( "Move spaces cannot be negative." );
                    return;
               }
               switch ( position )
               {
      ...
      public partial class MainWindow : Window
          {
               RobotTurtle robotTurtle;

               public MainWindow ( )
               {

                    InitializeComponent ( );
                    robotTurtle = new RobotTurtle ( 20 , 20 );
